...
<section className="accordions">
  ...
  <div class="accordion-header bg-darks shadow">
    ...
    <div className="accordion-body bg-darks shadow">
...
<input type="checkbox" value={m} onChange={props.methods.handlerChanges} />
      ...
      <input className="input  is-primary is-small mb-2 text-white bg-transparent" type="text" name='category' placeholder="Primary input" onChange={props.methods.handlerChanges}/>
  ...
  <span dangerouslySetInnerHTML={Card (m)} />
   <span className="delete is-small is-clickable" onClick={props.methods.removeTagArr}></span>
  </div>
      })
      }
      ...
      <div className='p-3'>
      <input className="input  is-primary is-small mb-2 bg-transparent text-white" type="text" name='tags' placeholder="Primary input" onChange={props.methods.handlerChanges}/>
